...
class _Home_PageState extends State<Home_Page> {
  ...
  String weatherCondition = (WeatherData.currentWeather != null)
      ...
      : 'Unknown Condition';
  String lastUpdated = (WeatherData.currentWeather != null)
      ? WeatherData.currentWeather!.lastUpdated
      : 'Unknown Time';
  String highTemp = (WeatherData.dailyWeather.isNotEmpty)
      ? '${WeatherData.dailyWeather[0].maxTemperature}°'
      : '??°';
  String lowTemp = (WeatherData.dailyWeather.isNotEmpty)
      ? '${WeatherData.dailyWeather[0].minTemperature}°'
      : '??°';
  WeatherIcon weatherIcon = WeatherData.GetWeatherIcon(
